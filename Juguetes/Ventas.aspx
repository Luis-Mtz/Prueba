...
ErrorMessage="Please Enter Only Numbers" ValidationGroup="alta"></asp:RegularExpressionValidator>--%>
                    ...
                    <asp:TemplateField HeaderText="ESTATUS">
                        ...
                        <ItemTemplate>
                            <asp:CheckBox Enabled="false" Checked='<%# Bind("Estatus") %>' ID="chk" runat="server"></asp:CheckBox>
                        </ItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Actualizar">
                        ...
                        <ItemTemplate>
                         <%--   <a href="EdicionUrl.aspx" target="_blank"> Actualizar </a>--%>
        ...
        <div class ="col-xs-12" style="text-align: right;">
            <asp:ImageButton  ImageUrl="~/Img/pdf-icon.png" Width="75px"  runat="server" 
                id="btnPdf" OnClick="btnPdf_Click"   />
                    </div>
