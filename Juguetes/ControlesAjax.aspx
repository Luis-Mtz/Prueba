<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ControlesAjax.aspx.cs" Inherits="ControlesAjax" %>
...
<body>
    ...
    <div class="demobottom"></div>
        ...
        <strong>Note: Recent changes will cause the PasswordStrength control to render differently compared to previous releases.
        This will affect the padding attributes of the BarIndicator display type. To achieve the same style as previous releases,
        you will need to add the following to the style for that control.</strong>
...
<pre>&lt;asp:PasswordStrength ID="PS" runat="server"
    ...
    <asp:CollapsiblePanelExtender ID="cpeDescription" runat="Server" 
        TargetControlID="Description_ContentPanel"
        ExpandControlID="Description_HeaderPanel"
        CollapseControlID="Description_HeaderPanel"
        Collapsed="False"
        ImageControlID="Description_ToggleImage" />
    <asp:CollapsiblePanelExtender ID="cpeProperties" runat="Server" 
